...
function checkCamera(location) {
	...
	} else if (location == '#loc3' ||  location == '#loc9'  || location == '#loc11'|| location == '#loc10'  || location == '#loc12') {
	...
	} else if (location == '#loc2' ||  location == '#loc4'  ) {
		document.getElementById('skybox').setAttribute('rotation', '-4.98 0 0');
	}
	else {
